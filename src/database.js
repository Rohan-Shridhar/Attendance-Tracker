...
export const STUDENTS_DB = {
  '1WN24CS175': { name: 'Aditi Rao', class: '3S' },
  '1WN24CS176': { name: 'Alok Nath', class: '3S' },
  '1WN24CS177': { name: 'Ananya Reddy', class: '3S' },
  '1WN24CS178': { name: 'Ankit Sharma', class: '3S' },
  '1WN24CS179': { name: 'Arnav Singh', class: '3S' },
  '1WN24CS180': { name: 'Bhavna Gupta', class: '3S' },
  '1WN24CS181': { name: 'Chetan Kumar', class: '3S' },
  '1WN24CS182': { name: 'Deepak Verma', class: '3S' },
  '1WN24CS183': { name: 'Ekta Joshi', class: '3S' },
  '1WN24CS184': { name: 'Gaurav Nair', class: '3S' },
  '1WN24CS185': { name: 'Harish Patel', class: '3S' },
  '1WN24CS186': { name: 'Jaya Menon', class: '3S' },
  '1WN24CS187': { name: 'Kunal Das', class: '3S' },
  '1WN24CS188': { name: 'Lalit Malik', class: '3S' },
  '1WN24CS189': { name: 'Manoj Chopra', class: '3S' },
  '1WN24CS190': { name: 'Nisha Singh', class: '3S' },
  '1WN24CS191': { name: 'Omkar Chand', class: '3S' },
  '1WN24CS192': { name: 'Pankaj Kapoor', class: '3S' },
  '1WN24CS193': { name: 'Parul Bhat', class: '3S' },
  '1WN24CS194': { name: 'Prateek Kulkarni', class: '3S' },
  '1WN24CS195': { name: 'Rachna Desai', class: '3S' },
  '1WN24CS196': { name: 'Rajiv Thakur', class: '3S' },
  '1WN24CS197': { name: 'Rakesh Goyal', class: '3S' },
  '1WN24CS198': { name: 'Renu Saxena', class: '3S' },
  '1WN24CS199': { name: 'Sachin Sinha', class: '3S' },
  '1WN24CS200': { name: 'Sameer Kumar', class: '3S' },
  ...
  '1WN24CS251': { name: 'Aditya Singh', class: '3V' },
  '1WN24CS252': { name: 'Bhavna Sharma', class: '3V' },
  '1WN24CS253': { name: 'Chetan Reddy', class: '3V' },
  '1WN24CS254': { name: 'Deepika Patel', class: '3V' },
  '1WN24CS255': { name: 'Eshan Gupta', class: '3V' },
  '1WN24CS256': { name: 'Farah Verma', class: '3V' },
  '1WN24CS257': { name: 'Girish Nair', class: '3V' },
  '1WN24CS258': { name: 'Heena Rao', class: '3V' },
  '1WN24CS259': { name: 'Imran Joshi', class: '3V' },
  '1WN24CS260': { name: 'Jatin Das', class: '3V' },
  '1WN24CS261': { name: 'Kriti Menon', class: '3V' },
  '1WN24CS262': { name: 'Lokesh Malik', class: '3V' },
  '1WN24CS263': { name: 'Mohit Chopra', class: '3V' },
  '1WN24CS264': { name: 'Nandini Singh', class: '3V' },
  '1WN24CS265': { name: 'Ojas Chand', class: '3V' },
  '1WN24CS266': { name: 'Prakash Kapoor', class: '3V' },
  '1WN24CS267': { name: 'Qamar Bhat', class: '3V' },
  '1WN24CS268': { name: 'Ravi Kulkarni', class: '3V' },
  '1WN24CS269': { name: 'Sonia Desai', class: '3V' },
  '1WN24CS270': { name: 'Tarun Thakur', class: '3V' },
  '1WN24CS271': { name: 'Usha Goyal', class: '3V' },
  '1WN24CS272': { name: 'Vivek Saxena', class: '3V' },
  '1WN24CS273': { name: 'Wasim Sinha', class: '3V' },
  '1WN24CS274': { name: 'Yamini Kumar', class: '3V' },
  '1WN24CS275': { name: 'Zoya Khan', class: '3V' },
};
